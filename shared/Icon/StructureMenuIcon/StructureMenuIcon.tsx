const StructureMenuIcon = () => {

    return (
        <svg fill="#e7e7e7" height="32px" width="32px" viewBox="0 0 448 448" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" >
...
export default StructureMenuIcon