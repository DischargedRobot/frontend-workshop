...
# Переменные для сборки
ENV NEXT_PUBLIC_AUTH_SERVICE_URL_V1=$NEXT_PUBLIC_API_URL$NEXT_PUBLIC_AUTH_SERVICE_URL_V1
ENV NEXT_PUBLIC_AUTH_URL_V1=$NEXT_PUBLIC_API_URL$NEXT_PUBLIC_AUTH_URL_V1
ENV NEXT_PUBLIC_CLIENT_URL_V1=$NEXT_PUBLIC_API_URL$NEXT_PUBLIC_CLIENT_URL_V1
ENV NEXT_PUBLIC_API_FF_SERVICE_URL_V1=$NEXT_PUBLIC_API_URL$NEXT_PUBLIC_API_FF_SERVICE_URL_V1
ENV NEXT_PUBLIC_API_ORGANIZATIONS_URL_V1=$NEXT_PUBLIC_API_URL$NEXT_PUBLIC_API_ORGANIZATIONS_URL_V1
# для сервера - мидлеваре
